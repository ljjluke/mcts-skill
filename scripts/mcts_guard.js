...
const CONSTRAINT_CHECKLIST = [
    { id: 'methodology',          category: 'hard', question: 'Is the methodology/approach clearly defined?', auto_detect: true, auto_detect_hint: 'Check available materials, docs, or standards' },
    { id: 'resources_external',   category: 'hard', question: 'Can external resources/suppliers be introduced?', auto_detect: false, auto_detect_hint: 'Check available materials or resource lists' },
    { id: 'structure',            category: 'hard', question: 'Are there structural/organizational hard constraints?', auto_detect: true, auto_detect_hint: 'Check available materials or organizational docs' },
    { id: 'compliance',           category: 'hard', question: 'Any compliance/policy/regulatory restrictions?', auto_detect: false },
    { id: 'performance',          category: 'soft', question: 'Any performance/quality requirements? (speed, capacity, standards)', auto_detect: false },
    { id: 'safety',               category: 'hard', question: 'Are there safety/protection requirements?', auto_detect: true },
    { id: 'time_budget',          category: 'soft', question: 'Any time/cost limits? (deadline, budget cap)', auto_detect: false },
    ...
    return {
        ...
        dimensions: [
            { id: 'tian', name: '天·Timing', quote: '天者，阴阳、寒暑、时制也 — Sunzi Bingfa',
              ...
              domain_examples: { software: 'sprint deadline? tech stack maturity?', medicine: 'acute/chronic? treatment window? comorbidity stage?', education: 'semester start/mid/end? student readiness?', driving: 'weather? road conditions? time of day?', finance: 'market phase? fiscal quarter? interest rate cycle?', agriculture: 'planting season? harvest window? weather forecast?' },
            ...
            { id: 'di', name: '地·Resources', quote: '地者，远近、险易、广狭、死生也 — Sunzi Bingfa',
              ...
              domain_examples: { software: 'team size? infra? can add dependencies?', medicine: 'available drugs? equipment? hospital capacity?', education: 'class size? materials? classroom setup?', driving: 'vehicle condition? fuel? route alternatives?', finance: 'capital? liquidity? risk exposure?', agriculture: 'land area? equipment? irrigation? labor?' },
            ...
            { id: 'ren', name: '人·People', quote: '上下同欲者胜 — Sunzi Bingfa | 人和不如地利 — Mengzi',
              ...
              domain_examples: { software: 'end users? stakeholders? team culture?', medicine: 'patient preferences? family? care team dynamics?', education: 'student learning styles? parent expectations?', driving: 'passengers? other drivers? traffic culture?', finance: 'investors? clients? regulators?', agriculture: 'consumers? supply chain? local community?' },
            ...
            { id: 'fa', name: '法·Rules', quote: '法者，曲制、官道、主用也 — Sunzi Bingfa',
              ...
              domain_examples: { software: 'compliance? CI/CD? architecture constraints?', medicine: 'clinical guidelines? consent? licensing?', education: 'curriculum standards? school policy? accreditation?', driving: 'traffic laws? company fleet policy? insurance?', finance: 'regulatory compliance? reporting standards? audit?', agriculture: 'food safety standards? certifications? quotas?' },
            ...
            { id: 'wu', name: '物·Essence', quote: '大道至简 — Laozi | 知止而后有定 — Daxue',
              ...
              domain_examples: { software: 'what problem does this feature actually solve?', medicine: "what's the treatment goal? palliative vs curative?", education: 'what should students actually learn?', driving: "what's the real destination? shortest vs safest?", finance: "what's the real investment goal? growth vs income?", agriculture: "what's the core output? yield vs quality vs sustainability?" },
        ...
        constraint_handling_anti_patterns: [
            { id: 'cannot_fabricate', rule: '"Cannot fabricate" ≠ "output empty template only". Correct: search available data → output with source → annotate uncertainty [source pending verification]' },
            { id: 'no_direct_access', rule: '"Cannot access directly" ≠ "cannot output any information". Correct: search existing public sources → cite verifiable info' },
            { id: 'ai_identity', rule: '"I am an AI" ≠ "I cannot help". Correct: search → organize available information → give usable output to user' },
        ],
        low_facet_procedure: [
...
function simulateDetail() {
    return {
        knowledge_acquisition: {
            ...
            level2_self_learn: {
                self_learnable: ['Domain knowledge: key concepts, standard practices', 'Best practices: common approaches for scenario', 'Reference data: known facts, guidelines, specifications'],
