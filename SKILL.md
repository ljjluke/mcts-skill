...
**详细规则见 `engine/mcts-diverge.md`**。核心流程：

```
① 六维领域地图: 技术栈/架构/业务/安全/运维/体验 → 各维度0-10自评 → 识别盲区
② 六路侦查: 项目代码+技术文档+竞品+用户视角+失败案例+趋势 → 交叉验证
③ 视角轮盘: 从10种视角中激活4~8个 → 每个视角生成1个方案
④ 粗筛: 方案>8时触发，保留top-3~5

关键规则: 不凑数、不虚构、不遗漏、一需求一发散
```
